...
describe('getItemsBySection("bread")', () => {
  it('should return "Bagles", "Baguette/French Bread", and "Croissants"',
    done => {
...
describe('allShoppers()', () => {
  it('should return the names of all shoppers who have atleast 1 order or more',
    done => {
